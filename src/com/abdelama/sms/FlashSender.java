...
/**
 * Class <code>FlashSender</code> sends a single flash SMS by manipulating the
 * data coding
 * 
...
public class FlashSender {
	...
	byte dataCoding = (byte) 240; // Silent SMS 192 // Flash SMS 240 // WAP Push 245 // Default 0
	 ...
	 */
	public FlashSender() throws IOException {
	...
	public static void main(String args[]) {
		...
		FlashSender smppSender = null;
		try {
			smppSender = new FlashSender();
		} catch (IOException e) {
