...
/**
 * Class <code>SilentSender</code> sends a single silent SMS by manipulating the
...
public class SilentSender {
	...
	byte dataCoding = (byte) 192; // Silent SMS 192 // Flash SMS 240 // WAP Push 245 // Default 0
	 ...
	 */
	public SilentSender() throws IOException {
	...
	public static void main(String args[]) {
		...
		SilentSender smppSender = null;
		try {
			smppSender = new SilentSender();
		} catch (IOException e) {
