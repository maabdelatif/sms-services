...
/**
 * Class <code>NormalSMSSender</code> sends a single silent SMS by manipulating
 * the data coding to specify a message wait indicator with discard flag
 * 
 * @author Logica Mobile Networks SMPP Open Source Team, since adapted slightly
 *         by Mohamed Abdelatif
 */
public class NormalSMSSender {
	...
	byte dataCoding = (byte) 0; // Silent SMS 192 // Flash SMS 240 // WAP Push
								// 245 // Default 0
	 ...
	 */
	public NormalSMSSender() throws IOException {
	...
	public static void main(String args[]) {
		...
		NormalSMSSender smppSender = null;
		try {
			smppSender = new NormalSMSSender();
		} catch (IOException e) {
			System.out.println("Exception initialising SMPPSender " + e);
		}

		message = "FIFA 15 will be so realistic that when Messi runs for more than 2 miles he will win the Golden Ball";
		// message =
		// "£$•ËÈ˘ÏÚ«ÿ¯≈Â∆Êﬂ… !\"§$%&'()*+,-./01239:;?ABCYZƒ÷—‹ßabcxyz‰ˆÒ¸‡{}\\[~]@Ä";
		// ByteBuffer messagePayload = new ByteBuffer();
		// messagePayload.appendBytes(message.getBytes());
		// message =
		// "a324a5e8e9f9ecf2c7d8f8c5e5c6e6dfc9202122a42425262728292a2b2c2d2e2f30313233393a3b3f414243595ac4d6d1dca761626378797ae4f6f1fce07b7d5c5b7e5d4080";
	 ...
	 * @see SubmitSMResp
	 */
	private void submit(String destAddress, String shortMessage, String sender,
